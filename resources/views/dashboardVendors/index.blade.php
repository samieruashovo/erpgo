...
@section('action-btn')
    <div class="float-end">
        <a href="#" data-size="md" data-url="{{ route('dashboardVendors.create') }}" data-ajax-popup="true"  data-bs-toggle="tooltip" title="{{__('Create Client')}}"  class="btn btn-sm btn-primary">
