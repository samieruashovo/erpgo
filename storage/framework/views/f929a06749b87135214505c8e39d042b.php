                    ...
                    <div class="card em-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo Form::textarea('address', old('address'), ['class' => 'form-control',  'required' => 'required' , 'rows' => 2 ,'placeholder'=>'Enter employee address']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-icon-user">
                                        <?php echo e(Form::select('branch_id', $branches, null, ['class' => 'form-control select2', 'placeholder' => 'Select Branch'])); ?>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-icon-user">
                                        <?php echo e(Form::select('department_id', $departments, null, ['class' => 'form-control select2', 'id' => 'department_id',  'placeholder' => 'Select Department'])); ?>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-icon-user">
                                        ...
                                        <?php echo e(Form::select('designation_id', $designations, null, ['class' => 'form-control select2', 'id' => 'designation_id', 'placeholder' => 'Select Designation'])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/samier/Downloads/erp_sagor_vai_project/erpgo/resources/views/employee/create.blade.php ENDPATH**/ ?>