                ...
                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3">
                        <div class="card text-center">
                                    ...
                                    <div class="btn-group card-option">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit client')): ?>
                                                <a href="#!" data-size="md" data-url="<?php echo e(route('clients.edit',$client->id)); ?>" data-ajax-popup="true" class="dropdown-item" data-bs-original-title="<?php echo e(__('Edit Client')); ?>">
                                        ...
                                        <?php elseif($client->is_enable_login == 0 && $client->password == null): ?>
                                            <a href="#" data-url="<?php echo e(route('clients.reset', \Crypt::encrypt($client->id))); ?>"
                            ...
                            <a href="<?php echo e(route('vendorClient.page', ['id' => $client->id])); ?>">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <h6 class="mb-0"> <?php if($client->clientDeals): ?>
                                            ...
                                            <?php endif; ?></h6>
                                        <p class="text-muted text-sm mb-0"><?php echo e(__('Total Paid')); ?></p>
                                    </div>
                                    <div class="col-6">
                                        <h6 class="mb-0"><?php if($client->clientProjects): ?>
                                            ...
                                            <?php endif; ?></h6>
                                        <p class="text-muted text-sm mb-0"><?php echo e(__('Total Due')); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/samier/Downloads/erp_sagor_vai_project/erpgo/resources/views/clients/index.blade.php ENDPATH**/ ?>