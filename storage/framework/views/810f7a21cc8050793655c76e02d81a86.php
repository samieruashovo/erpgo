                        ...
                        <table class="table datatable">
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="font-style">
                                        <?php if(array_key_exists($category->type, \App\Models\ProductServiceCategory::$catTypes)): ?>
                                            <?php echo e(__(\App\Models\ProductServiceCategory::$catTypes[$category->type])); ?>

                                        <?php else: ?>
                                            <?php echo e(__('Undefined category type')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/samier/Downloads/erp_sagor_vai_project/erpgo/resources/views/productServiceCategory/index.blade.php ENDPATH**/ ?>